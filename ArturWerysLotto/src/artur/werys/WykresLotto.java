...
public class WykresLotto {
    ...
    public WykresLotto() {
        ...
        chart = ChartFactory.createBarChart("Histogram trafień", 
                "Liczba trafień", // Opis osi X
                "Ilość losowań", // Opis osi Y
                dataset, // Dane
    ...
    public void addDataToDataset() {
        dataset.addValue(GuiMain.ile0, "Trafienia", "Zero");
        dataset.addValue(GuiMain.ile1, "Trafienia", "Jedynka");
        dataset.addValue(GuiMain.ile2, "Trafienia", "Dwójka");
        dataset.addValue(GuiMain.ile3, "Trafienia", "Trójka");
        dataset.addValue(GuiMain.ile4, "Trafienia", "Czwórka");
        dataset.addValue(GuiMain.ile5, "Trafienia", "Piątka");
        dataset.addValue(GuiMain.ile6, "Trafienia", "Szóstka");
    }
